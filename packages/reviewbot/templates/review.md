...
## Cumulative diff since {{referenceLabel}}

{{#files}}
--- {{path}} vs {{referenceLabel}} ---
{{diffVsBase}}

{{/files}}
{{#history}}
## What you reported at {{previousLabel}}

Each line is tagged with whether its code has changed since then.

{{reportedFindings}}

## What has changed since {{previousLabel}}

{{#files}}
--- {{path}}, changed since {{previousLabel}} ---
